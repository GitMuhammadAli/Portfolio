...
function FullStackIcon({ size }: { size: number }) {
  return (
    <IconBase size={size} bg1="#4338ca" bg2="#fafafa" border="rgba(255,255,255,0.15)">
      {/* Code brackets */}
      <text x="30" y="58" fontSize="32" fontFamily="monospace" fontWeight="bold" fill="#c7d2fe" opacity="0.9">&lt;/&gt;</text>
      {/* Bottom layer accent */}
      <rect x="28" y="66" width="44" height="4" rx="2" fill="#fafafa" opacity="0.5" />
      <rect x="34" y="73" width="32" height="3" rx="1.5" fill="#fafafa" opacity="0.3" />
    </IconBase>
  )
}
...
function BackendIcon({ size }: { size: number }) {
  return (
    <IconBase size={size} bg1="#6d28d9" bg2="#a1a1aa" border="rgba(255,255,255,0.15)">
      {/* Server rack lines */}
...
function LearnerIcon({ size }: { size: number }) {
  return (
    <IconBase size={size} bg1="#b45309" bg2="#fafafa" border="rgba(255,255,255,0.15)">
      {/* Book base */}
...
function GithubIcon({ size }: { size: number }) {
  return (
    <IconBase size={size} bg1="#0e7490" bg2="#71717a" border="rgba(255,255,255,0.15)">
      {/* Octocat simplified */}
...
function CertificationsIcon({ size }: { size: number }) {
  return (
    <IconBase size={size} bg1="#b45309" bg2="#d97706" border="rgba(255,255,255,0.15)">
      ...
      />
      {/* Ribbon */}
      <path d="M38 60 L34 74 L42 68 L50 74 L58 68 L66 74 L62 60" fill="#fafafa" opacity="0.4" />
    </IconBase>
  )
}
...
function DevradarIcon({ size }: { size: number }) {
  return (
    <IconBase size={size} bg1="#6d28d9" bg2="#a1a1aa" border="rgba(255,255,255,0.12)">
...
function ApodReactIcon({ size }: { size: number }) {
  return (
    <IconBase size={size} bg1="#3730a3" bg2="#fafafa" border="rgba(255,255,255,0.12)">
      {/* Telescope */}
