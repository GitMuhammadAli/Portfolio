  ...
  return (
    <div className={cn("w-full", className)}>
      <div
        ...
        role="tablist"
        onKeyDown={onKeyDown}
        className="relative inline-flex items-center gap-1 p-1 rounded-xl bg-zinc-900/50 backdrop-blur-sm border border-zinc-800"
      >
        {indicator && !prefersReducedMotion && (
          <>
            ...
            <motion.div
              ...
              className="absolute pointer-events-none rounded-md opacity-95"
              style={{
                top: 8,
        ...
        {items.map((item, i) => (
          <button
            ...
            className={cn(
              ...
              i === active ? "text-white" : "text-zinc-400 hover:text-zinc-200"
            )}
          >
            {item.label}
          </button>
