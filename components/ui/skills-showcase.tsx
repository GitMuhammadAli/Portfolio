  ...
  return (
    <div className={cn('flex flex-col w-full max-w-md', className)}>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <span className="text-[10px] font-semibold tracking-[0.25em] uppercase text-fg-muted">
          {title}
        </span>
      </div>
          ...
          >
            <div
              className={cn(
                ...
                'rounded-lg',
                hoveredIndex === index ? 'bg-bg-muted' : 'bg-transparent',
              )}
            >
                ...
                <div
                  className={cn(
                    ...
                    hoveredIndex === index
                      ...
                      : 'bg-border-strong scale-y-50 opacity-0',
                  )}
                />
                <span
                  className={cn(
                    ...
                    hoveredIndex === index
                      ? 'text-fg translate-x-0'
                      : 'text-fg-muted -translate-x-5',
                  )}
                >
                  {skill.name}
                </span>
              ...
              <div className="flex items-center gap-4">
                <div className="relative w-24 h-1 rounded-full overflow-hidden bg-bg-muted">
                  <div
                    className={cn(
                    ...
                    style={{
                      ...
                      background: 'linear-gradient(to right, color-mix(in srgb, var(--accent) 70%, transparent), var(--accent))',
                  ...
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(to right, transparent, color-mix(in srgb, var(--fg) 25%, transparent), transparent)',
                ...
                <div className="relative w-10 overflow-hidden">
                  <span
                    className={cn(
                      ...
                      'transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]',
                      hoveredIndex === index
                        ? 'text-fg opacity-100 translate-y-0 blur-0'
                        : 'text-fg-subtle opacity-0 translate-y-3 blur-sm',
                    )}
                  >
                    {skill.level}%
                  </span>
